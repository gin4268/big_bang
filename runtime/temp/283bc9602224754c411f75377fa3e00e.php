<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\phpStudy\WWW\java/application/index\view\admin\login.html";i:1522918243;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div>
		<form action="<?php echo url('admin/loginin'); ?>" method='post' onsubmit="return check();">
